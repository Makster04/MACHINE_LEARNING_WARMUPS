...
![Die faces with evens shaded as A and odds as its complement](../figures/01-complement-dark.png)
...
![Venn diagram with the full union of A and B shaded](../figures/01-union-dark.png)
...
![Venn diagram with only the intersection of A and B shaded](../figures/01-intersection-dark.png)
...
![Venn diagram showing the soccer-basketball overlap counted twice](../figures/01-double-counting-dark.png)
...
![A valid partition of the die faces above a non-exhaustive pair below](../figures/01-partition-dark.png)
